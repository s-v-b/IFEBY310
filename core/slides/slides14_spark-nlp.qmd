...
# Toy (big) data  {background-color="#1c191c"}
...
Spark NLP relies on Spark SQL for storing, moving, data.
...
## Getting a corpus (cont'd)

```{python}
#| label: Getting-the-ny-data
...
## Chaining annotators (cont'd) {.scrollable}
