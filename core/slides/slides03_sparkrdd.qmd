...
`r fontawesome::fa("radiation")`Warning. If the function is an *object method*:
...
- `r fontawesome::fa("triangle-exclamation")` Be sure that the *retrieved data fits in the driver memory* !
- Useful when developping and working on small data for testing
- `r fontawesome::fa("hand-point-right")` We'll use it a lot here, but *we don't use it in real-world problems*
...
- `r fontawesome::fa("triangle-exclamation")` the result  may be a *biased* collection
...
## Reminder: about passing functions (`r fontawesome::fa("syringe")`)
...
Passing a function with field references (don’t do this !  `r fontawesome::fa("hammer")` `r fontawesome::fa("skull-crossbones")`)
...
## `r fontawesome::fa("triangle-exclamation")` Warning
...
<center>
  <img width='600px' src="/images/join-types.png">
</center>
